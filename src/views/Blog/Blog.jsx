                        ...
                        <div className="card blog-card w-100 shadow-sm" key={ind} style={{ minWidth: "45%" }}>
                            <div className="row align-items-center">
                                ...
                                <div className="col-2 d-flex flex-column justify-content-center align-items-center gap-5">
                                    ...
                                    {user?.role == "admin" &&
                                        <button className="btn suppr" onClick={() => supprimer(p.id_publication)}><svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="red" className="bi bi-ban" viewBox="0 0 16 16">
