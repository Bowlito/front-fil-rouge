...
export default function Header() {
  ...
  return (
    ...
    >
      ...
      {user &&
        <button className="btn m-2 info" style={{ color: "#eb7c05d0" }} onClick={logout}><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-door-open" viewBox="0 0 16 16">
